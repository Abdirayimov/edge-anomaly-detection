...
find_library(TensorRT_NVINFER_LIB NAMES nvinfer
    HINTS /usr/lib/x86_64-linux-gnu /usr/local/lib ${TensorRT_ROOT}/lib)
find_library(TensorRT_NVONNXPARSER_LIB NAMES nvonnxparser
    HINTS /usr/lib/x86_64-linux-gnu /usr/local/lib ${TensorRT_ROOT}/lib)
...
if(TensorRT_INCLUDE_DIR AND EXISTS "${TensorRT_INCLUDE_DIR}/NvInferVersion.h")
    ...
    set(TensorRT_VERSION "${_trt_major}")
endif()
